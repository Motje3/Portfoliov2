...
const OfficeCalenderProjectPage = () => {
  ...
  const features = [
    {
      ...
      description:
        "Coordinate schedules easily with a shared view of all team events.",
      icon: "📅",
    ...
    },
    {
      ...
      description:
        "Create, edit, and delete meetings and events with just a few clicks.",
      icon: "🛠️",
    ...
    {
      title: "User Roles",
      description: "Differentiate access with admin and user-level roles.",
      icon: "🔐",
  ...
  const techStack = [
    {
      name: "TypeScript",
      icon: "🔵", // Or you could use a Unicode character if you prefer, like '🇹‌🇸' or find a specific icon font
      color: "text-blue-500", // Standard TypeScript blue
      bgGradient: "from-blue-500/20 to-sky-400/20",
      // Description: "The primary language, adding static typing for robust, scalable, and maintainable code in both frontend and backend parts of the OfficeCalendar."
    },
    {
      name: "C#",
      icon: "#️⃣", // Or '♯', or a .NET swirl if you can use an image/SVG
      color: "text-purple-500", // Often associated with C# / .NET
      bgGradient: "from-purple-500/20 to-violet-400/20",
      // Description: "Powers the backend API, handling business logic, data management, and server-side operations for the OfficeCalendar."
    },
    {
      name: "SCSS",
      icon: "🎨", // Or an icon representing 'Sass' like 💅 (nail polish, often used humorously)
      color: "text-pink-500", // Common color for Sass/SCSS
      bgGradient: "from-pink-500/20 to-rose-400/20",
      // Description: "Used for advanced and organized styling, enabling cleaner CSS with variables, mixins, and nested rules for the UI."
    },
    {
      name: "HTML",
      icon: "📄", // Classic HTML representation
      color: "text-orange-500", // Standard HTML5 orange
      bgGradient: "from-orange-500/20 to-amber-400/20",
      // Description: "The foundational structure of the web application, defining the content and layout for all user-facing pages."
    },
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            >
              ...
              >
                A collaborative calendar web app built by our school team to
                manage
                <motion.span
              ...
              >
                <a
                  href="https://github.com/yassyass2/OfficeCalendar-team6"
                  target="_blank"
            ...
            >
              <div className="relative w-96 h-96">
                ...
                {[
                  { icon: "📅", pos: { top: "5%", left: "5%" }, delay: 0 }, // calendar
                  { icon: "🖊️", pos: { top: "15%", right: "5%" }, delay: 1 }, // pen
                  { icon: "📂", pos: { bottom: "25%", left: "0%" }, delay: 2 }, // folder
                  { icon: "🖥️", pos: { bottom: "5%", right: "10%" }, delay: 3 }, // monitor
                  { icon: "🕒", pos: { top: "40%", left: "-5%" }, delay: 4 }, // clock
                  { icon: "📋", pos: { top: "60%", right: "0%" }, delay: 5 }, // clipboard
                ].map((item, index) => (
                  <motion.div
                    key={index}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400 max-w-3xl mx-auto text-xl">
              Core functionalities designed to enhance office coordination and
              team engagement.
            </p>
          </motion.div>
                  ...
                  <div className="relative z-10 text-center space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="text-gray-400 text-sm leading-relaxed">
                        {index === 0 &&
                          "The primary language, adding static typing for robust, scalable, and maintainable code in the OfficeCalendar."}
                        {index === 1 &&
                          "Powers the backend API, handling business logic, data management, and server-side operations."}
                        {index === 2 &&
                          "Used for advanced and organized styling, enabling cleaner CSS with variables, mixins, and nested rules for the UI."}
                        {index === 3 &&
                          "The foundational structure of the web application, defining the content and layout for all user-facing pages."}
                      </p>
                    </div>
...
export default OfficeCalenderProjectPage;
