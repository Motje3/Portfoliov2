...
const ProjectsSection = ({
  ...
  const projects = [
    {
      id: 1,
      title: "Home Lab",
      description: "A comprehensive home lab environment designed for practicing cybersecurity concepts, penetration testing, and network security analysis.",
    ...
    },
    {
      id: 2,
      title: "Warehouse API",
      description: "A robust FastAPI-based warehouse order management system with real-time inventory tracking and automated order processing.",
    ...
    },
    {
      ...
      description: "A full-stack event calendar application with responsive design, user authentication, and real-time event synchronization.",
  ...
  return (
    <motion.section
      ...
      viewport={{ once: true }}
      style={{
        background: 'radial-gradient(circle at 25% 25%, rgba(59, 130, 246, 0.1) 0%, transparent 50%), radial-gradient(circle at 75% 75%, rgba(147, 51, 234, 0.1) 0%, transparent 50%)',
      }}
    >
      ...
      <div className="relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {projects.map((project, index) => (
            ...
            >
              {/* Glassmorphism card */}
              <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 h-full hover:bg-white/10 hover:border-white/20 transition-all duration-500 group-hover:scale-[1.02] group-hover:shadow-2xl group-hover:shadow-blue-500/10">
